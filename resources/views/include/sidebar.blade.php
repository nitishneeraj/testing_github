            ...
            <ul id="side-menu">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarEcommerce">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('manage-parties') }}"><i data-feather="list"
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarCrm">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('add-gst-bill') }}"><i data-feather="plus"
                                        class="pr-0 mr-1"></i>Create bill</a>
                            </li>
                            <li>
                                <a href="{{ route('manage-gst-bills') }}"><i data-feather="list"
                                        class="pr-0 mr-1"></i>Manage all bills</a>
                            </li>
                        </ul>
                    </div>
                </li>
